...
public class PixyCami2C extends SubsystemBase {
    ...
    public static int PIXY_ADDRESS = 0x33;
    private I2C port;
    private boolean inRange;
    private double offset;


    public ArrayList<PixyBlock> pixyBlocks = new ArrayList<>();
    ...
    public ArrayList<PixyBlock> read() {
        ...
        port.read(0x55, 14, bytes);
        System.out.println(Byte.toString(bytes[4]));
        int index = 0;
